...
export function OurTeam() {
  ...
  return (
    <section css={tw`text-gray-700`}>
      <div css={tw`container px-5 pt-5 mx-auto`}>
        <div css={tw`flex flex-col text-center w-full mb-10`}>
          <h1 css={tw`text-2xl text-gray-900`}>{t(StringKeys.OUR_TEAM)}</h1>
            ...
            >
              <div css={tw`h-full flex flex-col items-center text-center`}>
                <Img
                  ...
                  title={t(team[node.base].nameStringKey)}
